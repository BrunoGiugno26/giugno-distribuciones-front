      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 animate-pulse">
        ...
        <div className="space-y-8">
          ...
          <div className="flex items-center space-x-4 pt-4">
            <Skeleton className="h-10 w-24 bg-amber-600 dark:bg-sky-600" />
            <Skeleton className="h-12 w-12 bg-amber-200 dark:bg-sky-200" />
            <Skeleton className="h-10 w-16 bg-gray-200 dark:bg-gray-700/70" />
            <Skeleton className="h-10 w-40 bg-amber-600 dark:bg-sky-600" />
          </div>
          <div className="flex items-center space-x-4 pt-4">
            ...
            <Skeleton className="h-12 w-full max-w-xs rounded-full bg-amber-600 dark:bg-sky-600" />
          </div>
        </div>
      </div>
    </div>
